...
// (conventions §24.1). It MUST be registered BEFORE any identity-header middleware
// on the protected group so that no handler trusts identity headers until the
